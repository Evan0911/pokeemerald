    ...
    case 1: // calculate experience points to redistribute
        {
            ...
            calculatedExp = (gSpeciesInfo[gBattleMons[gBattlerFainted].species].expYield * gBattleMons[gBattlerFainted].level / 7) * 5;
    ...
    case 5: // looper increment
        ...
        else
        {
            ...
            if (gBattleStruct->expGetterMonId < PARTY_SIZE)
                ...
                if (!gExpShareCheck && totalMon>viaSentIn){
                    gExpShareCheck = TRUE;
                    gBattleStruct->expGetterMonId = 0;
...
static void Cmd_getmoneyreward(void)
{
    u32 moneyReward = GetTrainerMoneyToGive(gTrainerBattleOpponent_A * 2);
    if (gBattleTypeFlags & BATTLE_TYPE_TWO_OPPONENTS)
        moneyReward += GetTrainerMoneyToGive(gTrainerBattleOpponent_B * 2);
